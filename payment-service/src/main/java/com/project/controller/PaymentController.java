...
public class PaymentController {
	...
	@PutMapping("updatestatus/{paymentId}/{status}")
	public ResponseEntity< PaymentResponse> updatePayment(@PathVariable long paymentId , @PathVariable String status) {
		...
		return ResponseEntity.status(HttpStatus.OK).body(payResp);
	}
}
